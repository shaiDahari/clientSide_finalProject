                ...
                const dbWrapper = {
                    ...
                    getExchangeRatesUrl: async function() {
                        try {
                            ...
                            return customUrl || 'https://shaidahari.github.io/exchaneRates_json/exchange-rates.json';
                        } catch (error) {
                            return 'https://shaidahari.github.io/exchaneRates_json/exchange-rates.json';
                        }
                    }
                };
